...
func (r *expenseRepo) Create(expense model.ExpenseCreateRequest) (int, error) {
	const query = `INSERT INTO expenses (value, description, expense_date, category_id, user_id)
					VALUES (:value, :description, :expense_date, :category_id, :user_id) RETURNING id;`
